<h2><a href="https://leetcode.com/problems/rank-scores/?envType=problem-list-v2&envId=db-db4-window-functions-ranking">2. Rank Scores</a></h2><h3>Medium</h3><hr><p>Table: <code>Scores</code></p>
